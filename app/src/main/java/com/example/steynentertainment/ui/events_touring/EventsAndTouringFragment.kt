 ...
 * Use the [EventsAndTouringFragment.newInstance] factory method to
...
class EventsAndTouringFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment EventsAndTouringFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            EventsAndTouringFragment().apply {

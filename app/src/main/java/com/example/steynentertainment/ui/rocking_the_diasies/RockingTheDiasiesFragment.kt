 ...
 * Use the [RockingTheDiasiesFragment.newInstance] factory method to
...
class RockingTheDiasiesFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment RockingTheDiasiesFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            RockingTheDiasiesFragment().apply {
